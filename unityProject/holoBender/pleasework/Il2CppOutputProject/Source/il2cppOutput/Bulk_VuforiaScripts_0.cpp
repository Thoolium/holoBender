...
IL_0024:
	...
	}
	{
		...
		bool L_13 = DefaultModelRecoEventHandler_IsModelTrackedInView_mE407A7CEA81A77427FB53814B8A240163AFB82EB(__this, L_12, /*hidden argument*/NULL);
		if (!L_13)
		{
			goto IL_009f;
		}
	}
	{
		...
		NullCheck(L_14);
		ModelRecoBehaviour_set_ModelRecoEnabled_mE4BA48AFA1E8AD6E31679D3DD47A80EBC512ADD0(L_14, (bool)0, /*hidden argument*/NULL);
		// mSearching = false;
...
IL_007e:
	{
		...
		bool L_16 = DefaultModelRecoEventHandler_IsModelTrackedInView_mE407A7CEA81A77427FB53814B8A240163AFB82EB(__this, L_15, /*hidden argument*/NULL);
		if (L_16)
		{
			goto IL_009f;
		}
	}
	{
		...
		NullCheck(L_17);
		ModelRecoBehaviour_set_ModelRecoEnabled_mE4BA48AFA1E8AD6E31679D3DD47A80EBC512ADD0(L_17, (bool)1, /*hidden argument*/NULL);
		// mSearching = true;
...
IL_0051:
	{
		...
		NullCheck(L_15);
		TrackableBehaviour_t579D75AAFEF7B2D69F4B68931D5A58074E80A7E4 * L_18 = TargetFinder_EnableTracking_mC68D1DAB31507EE67700652C4B7D91AB40F31F3C(L_15, L_16, L_17, /*hidden argument*/NULL);
	...
	}
	{
		...
		NullCheck(L_23);
		ModelRecoBehaviour_set_ModelRecoEnabled_mE4BA48AFA1E8AD6E31679D3DD47A80EBC512ADD0(L_23, (bool)0, /*hidden argument*/NULL);
	}
...
IL_0019:
	{
		...
		NullCheck(L_9);
		String_t* L_10 = TrackableBehaviour_get_TrackableName_m04FE2B8C75F6E62F42C6121E61EFB7C3B6676835(L_9, /*hidden argument*/NULL);
		String_t* L_11 = V_1;
